...
# __name__ is a way  for your python code to tell if the code is run as a script or imported as a module
# makes it easy to re-use code and turn into packages later
if __name__ == '__main__': 
  my_loc = (55.942150, -3.053740)
